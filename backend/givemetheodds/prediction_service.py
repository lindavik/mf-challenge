...
class PredictionService(object):
    ...
    def get_probability_of_success(self, countdown: int, hunter_schedule: Dict) -> int:
        ...
        if earliest_arrival_day > countdown:
            ...
            shortest_path = self._get_shortest_path_to_destination_avoiding_bounty_hunters(hunter_schedule)
    ...
    def _get_shortest_path_to_destination_avoiding_bounty_hunters(self, hunter_schedule: Dict):
        """
